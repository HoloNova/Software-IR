...
public record ChangeBaselinePlanningRequest(
   ...
   public ChangeBaselinePlanningRequest {
   ...
   public ChangeBaselinePlanningRequest(Path stateRoot, String expectedBaselineId, Path candidateSirFile, Path outputRoot, ChangeSet changeSet) {
      this(stateRoot, expectedBaselineId, candidateSirFile, outputRoot, changeSet, Optional.empty());
   }

   public static ChangeBaselinePlanningRequest digestBound(
      ...
      return new ChangeBaselinePlanningRequest(
         stateRoot, expectedBaselineId, candidateSirFile, outputRoot, changeSet, Optional.of(expectedCandidateSirSha256Hex)
      );
   }
}
